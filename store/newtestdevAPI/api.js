...
const newtestdevAPI = axios.create({
  baseURL: "https://new-test-193-dev-131893.botics.co",
  headers: {
...
function modules_two_factor_authentication_google_authenticator_qr_retrieve(payload) {
  return newtestdevAPI.get(`/modules/two-factor-authentication/google/authenticator/qr`);
}
...
function modules_two_factor_authentication_verify_otp_create_2(payload) {
  return newtestdevAPI.post(`/modules/two-factor-authentication/verify/otp/${payload.enable}`);
}
